            ...
            setPosition: function (elem, fixed) {
                ...
                if (fixed) {
                    if (isIE6) {
                        ...
                        style.top = docElem.clientHeight - 65 + 'px';
                    }

                    style.left = docElem.clientWidth - 160 + 'px';
                    //alert( docElem.clientHeight +'-'+docElem.clientWidth);
                    //alert(Dialog.getScroll( 'top' )+'-'+Dialog.getScroll( 'left' ));
                }
                else {
                    if (isIE6) {
