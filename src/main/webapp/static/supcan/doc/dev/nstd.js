...
function chan(ang) {
    if (ang == 315) return "100% 100%,0% 0%"; else if (ang == 270) return "100% 0%,0% 0%"; else if (ang == 225) return "100% 0%,0% 100%"; else if (ang == 180) return "0% 0%,0% 100%"; else if (ang == 135) return "0% 0%,100% 100%"; else if (ang == 90) return "0% 0%,100% 0%";
    return "0% 100%, 0% 0%";
}
function nstd() {
    ...
    } else if (agt.indexOf("chrome") >= 0) nstd_mo = 1;
...
function gwroundtop(x, bLeft, bRight, clr1, clr2, clrLine, lineThick, fillAngle, w, h) {
    ...
    if (nstd_ie > 0) {
        ...
        if (nstd_mo == 0) rt += 'background:#dddddd; background-image:linear-gradient(180deg, ' + clr1 + ', ' + clr2 + ');">'; else rt += 'background:#dddddd; background-image:-webkit-gradient(linear,' + chan(180) + ', from(' + clr1 + '), to(' + clr2 + ') );">';
        rt += s1 + '</div>';
        ...
        if (nstd_mo == 0) rt += 'background:#eeeeee; background-image:linear-gradient(' + fillAngle + 'deg, ' + clr1 + ', ' + clr2 + ');">' + s2 + '</div>'; else rt += 'background:#eeeeee; background-image:-webkit-gradient(linear,' + chan(fillAngle) + ', from(' + clr1 + '), to(' + clr2 + ') );">' + s2 + '</div>';
    }
    x.innerHTML = rt;
}
function gwround(x, bLeft, bRight, clr1, clr2, clrLine, lineThick, fillAngle, w, h, arcsz) {
    ...
    if (nstd_ie > 0) {
        ...
        if (bLeft && bRight) rt += 'border-radius:9px;'; else if (bLeft) rt += 'border-top-left-radius:9px;border-bottom-right-radius:9px;'; else if (bRight) rt += 'border-top-right-radius:9px;border-bottom-left-radius:9px;';
        if (nstd_mo == 0) rt += 'background:#eeeeee; background-image:linear-gradient(' + fillAngle + 'deg, ' + clr1 + ', ' + clr2 + ');">'; else rt += 'background:#eeeeee; background-image:-webkit-gradient(linear,' + chan(fillAngle) + ', from(' + clr1 + '), to(' + clr2 + ') );">';
        rt += x.innerHTML + '</div>';
    }
    x.innerHTML = rt;
}
