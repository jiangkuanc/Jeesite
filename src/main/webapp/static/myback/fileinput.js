...
(function ($) {
    ...
    FileInput.prototype = {
        ...
        renderBrowse: function () {
            ...
            return '<div id="selectId" class="' + css + '"' + status + '> ' + self.browseIcon + self.browseLabel + ' </div>';
        },
        ...
        renderUpload: function () {
            ...
            if (!self.isUploadable || self.isDisabled) {
                ...
                content = '<a id="uploadId" href="' + self.uploadUrl + '" title="' + self.uploadTitle + '" class="' + css + '"' + status + '>' + self.uploadIcon + self.uploadLabel + '</a>';
            }
            return content;
        }
    };
