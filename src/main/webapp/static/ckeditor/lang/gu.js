...
CKEDITOR.lang.gu = {
    ...
    smiley: {toolbar: 'સ્માઇલી', title: 'સ્માઇલી  પસંદ કરો', options: 'સમ્ય્લી વિકલ્પો'},
    ...
    font: {label: 'ફૉન્ટ', voiceLabel: 'ફોન્ટ', panelTitle: 'ફૉન્ટ'},
    ...
    fakeobjects: {anchor: 'અનકર', flash: 'ફ્લેશ ', iframe: 'IFrame', hiddenfield: 'હિડન ', unknown: 'અનનોન ઓબ્જેક્ટ'},
