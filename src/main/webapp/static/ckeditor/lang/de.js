...
CKEDITOR.lang.de = {
    ...
    smiley: {toolbar: 'Smiley', title: 'Smiley auswählen', options: 'Smiley Optionen'},
    elementsPath: {eleLabel: 'Elements Pfad', eleTitle: '%1 Element'},
    numberedlist: 'Nummerierte Liste',
    bulletedlist: 'Liste',
    indent: 'Einzug erhöhen',
    outdent: 'Einzug verringern',
    justify: {left: 'Linksbündig', center: 'Zentriert', right: 'Rechtsbündig', block: 'Blocksatz'},
    ...
    font: {label: 'Schriftart', voiceLabel: 'Schriftart', panelTitle: 'Schriftart'},
