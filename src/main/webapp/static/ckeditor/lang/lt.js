...
CKEDITOR.lang.lt = {
    ...
    smiley: {toolbar: 'Veideliai', title: 'Įterpti veidelį', options: 'Šypsenėlių nustatymai'},
    ...
    justify: {left: 'Lygiuoti kairę', center: 'Centruoti', right: 'Lygiuoti dešinę', block: 'Lygiuoti abi puses'},
    blockquote: 'Citata',
    clipboard: {
        title: 'Įdėti',
    ...
    font: {label: 'Šriftas', voiceLabel: 'Šriftas', panelTitle: 'Šriftas'},
