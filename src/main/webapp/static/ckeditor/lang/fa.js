...
CKEDITOR.lang.fa = {
    ...
    specialChar: {toolbar: 'گنجاندن نویسهٴ ویژه', title: 'گزینش نویسهٴ ویژه', options: 'گزینههای نویسههای ویژه'},
    link: {
    ...
    smiley: {toolbar: 'خندانک', title: 'گنجاندن خندانک', options: 'گزینههای خندانک'},
    ...
    justify: {left: 'چپچین', center: 'میانچین', right: 'راستچین', block: 'بلوکچین'},
    ...
    font: {label: 'قلم', voiceLabel: 'قلم', panelTitle: 'قلم'},
    fontSize: {label: 'اندازه', voiceLabel: 'اندازه قلم', panelTitle: 'اندازه'},
    colorButton: {
