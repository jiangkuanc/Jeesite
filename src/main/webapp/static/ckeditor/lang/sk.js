...
CKEDITOR.lang.sk = {
    ...
    textarea: {title: 'Vlastnosti textovej oblasti', cols: 'Stĺpce', rows: 'Riadky'},
    textfield: {
    ...
    hidden: {title: 'Vlastnosti skrytého poľa', name: 'Názov', value: 'Hodnota'},
    image: {
    ...
    smiley: {toolbar: 'Smajlíky', title: 'Vkladanie smajlíkov', options: 'Možnosti smajlíkov'},
    ...
    font: {label: 'Písmo', voiceLabel: 'Font', panelTitle: 'Písmo'},
    fontSize: {label: 'Veľkosť', voiceLabel: 'Veľkosť písma', panelTitle: 'Veľkosť'},
    colorButton: {
