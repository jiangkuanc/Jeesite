...
CKEDITOR.lang.mn = {
    ...
    smiley: {toolbar: 'Тодорхойлолт', title: 'Тодорхойлолт оруулах', options: 'Smiley Options'},
    ...
    pasteText: {button: 'Plain Text-ээс буулгах', title: 'Plain Text-ээс буулгах'},
    templates: {
        button: 'Загварууд',
    ...
    font: {label: 'Фонт', voiceLabel: 'Font', panelTitle: 'Фонт'},
    fontSize: {label: 'Хэмжээ', voiceLabel: 'Font Size', panelTitle: 'Хэмжээ'},
    colorButton: {
