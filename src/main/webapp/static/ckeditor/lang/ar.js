...
CKEDITOR.lang.ar = {
    ...
    specialChar: {toolbar: 'إدراج  خاص.ِ', title: 'اختر الخواص', options: 'Special Character Options'},
    link: {
        toolbar: 'رابط',
        other: '<أخرى>',
        menu: 'تحرير رابط',
    ...
    smiley: {toolbar: 'ابتسامات', title: 'إدراج ابتسامات', options: 'Smiley Options'},
    ...
    justify: {left: 'محاذاة إلى اليسار', center: 'توسيط', right: 'محاذاة إلى اليمين', block: 'ضبط'},
    blockquote: 'اقتباس',
    clipboard: {
        title: 'لصق',
    ...
    font: {label: 'خط', voiceLabel: 'حجم الخط', panelTitle: 'حجم الخط'},
