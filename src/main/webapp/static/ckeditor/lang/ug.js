...
CKEDITOR.lang.ug = {
    ...
    specialChar: {toolbar: 'ئالاھىدە ھەرپ قىستۇر', title: 'ئالاھىدە ھەرپ تاللاڭ', options: 'ئالاھىدە ھەرپ تاللانمىسى'},
    link: {
    ...
    font: {label: 'خەت نۇسخا', voiceLabel: 'خەت نۇسخا', panelTitle: 'خەت نۇسخا'},
