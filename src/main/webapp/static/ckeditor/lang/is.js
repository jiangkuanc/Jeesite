...
CKEDITOR.lang.is = {
    ...
    specialChar: {toolbar: 'Setja inn merki', title: 'Velja tákn', options: 'Special Character Options'},
    link: {
    ...
    smiley: {toolbar: 'Svipur', title: 'Velja svip', options: 'Smiley Options'},
    ...
    justify: {left: 'Vinstrijöfnun', center: 'Miðja texta', right: 'Hægrijöfnun', block: 'Jafna báðum megin'},
    ...
    font: {label: 'Leturgerð ', voiceLabel: 'Font', panelTitle: 'Leturgerð '},
