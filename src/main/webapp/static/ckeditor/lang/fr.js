...
CKEDITOR.lang.fr = {
    ...
    smiley: {toolbar: 'Émoticones', title: 'Insérer un émoticone', options: 'Options des émoticones'},
    ...
    justify: {left: 'Aligner à gauche', center: 'Centrer', right: 'Aligner à droite', block: 'Justifier'},
    blockquote: 'Citation',
    clipboard: {
        title: 'Coller',
    ...
    font: {label: 'Police', voiceLabel: 'Police', panelTitle: 'Style de police'},
