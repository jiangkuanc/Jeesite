...
CKEDITOR.lang.bg = {
    ...
    smiley: {toolbar: 'Усмивка', title: 'Вмъкване на усмивка', options: 'Опции за усмивката'},
    ...
    justify: {left: 'Подравни в ляво', center: 'Център', right: 'Подравни в дясно', block: 'Justify'},
    ...
    font: {label: 'Шрифт', voiceLabel: 'Шрифт', panelTitle: 'Име на шрифт'},
