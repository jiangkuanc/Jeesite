...
<form action="${ctx}/financing/payment/enterPay" method="post">
    ...
    <table border="1" cellpadding="1" cellspacing="1" align="center" width="50%">
        <tr>
            <td>13. 商户系统订单号:</td>
            <td><input type="text" name="orderNo" id="orderNo" value=""/><font color="red">*</font><input type="button"
                                                                                                          value="生成订单号"
                                                                                                          onclick="setOrderNo()"/>
            </td>
            <td></td>
...
<script language="javascript">
    ...
    function AttributeJudge() {
        ...
        document.getElementById("serverUrl").value = "http://ceshi.allinpay.com/gateway/index.do?";
