    ...
    <div class="rzsq-con">
        <form id="interviewForm" method="post" class="form-horizontal" action="${ctx}/rating/front/updateAppInfo">
            ...
            <div class="form-group">
                ...
                <div class="col-lg-3 checkbox" style="margin-top: 6px">
            ...
            <div class="form-group">
                ...
                <div class="col-lg-3 checkbox" style="margin-top: 6px">
                    ${p2p.p2pEnterpriseCertify.p2pIndustryclassi.classinameCn}
                </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <div class="col-lg-8 checkbox" style="margin-top: 6px">
            ...
            <div class="form-group">
                ...
                <div class="col-lg-3 checkbox" style="margin-top: 6px" id="quasiNuclearDate">
                </div>
            </div>
            <div class="form-group">
