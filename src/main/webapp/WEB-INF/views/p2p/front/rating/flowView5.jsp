...
<head>
    ...
    <script type="text/javascript">
        ...
        function sendForm(fid) {
            post('${ctx}/rating/front/viewRatingFeedback', {
...
<div class="zh-right pull-left jianjie shenq"
    ...
    <div class="noWrap">
        <p class="shenqp pull-left">
            您好,<span>${p2pRegUserCertify.realName}</span>,您所在企业的信用评级已经完成，
            请在查看评级结果后向我们反馈您的意见
        </p>

        <a style="margin-left: 160px;"
           href="javascript:sendForm('${financingInformationId}')"><input
                type="button" style="margin-left: -10%" class="btn btn-default red"
                value="确认评级结果">
        </a>
    </div>
    <h2>申请进度：</h2>
