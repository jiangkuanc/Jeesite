...
<head>
    ...
    <script type="text/javascript">
        ...
        function sendForm(fid) {
            post('${ctx}/rating/front/preSupplyDocument', {
...
<div class="zh-right pull-left jianjie shenq"
    ...
    <c:if test="${isSupply == 0}">
        <p class="shenqp pull-left">
            您好,<span>${p2pRegUserCertify.realName}</span>,您的债项正在进行评级，请耐心等候
        </p>
        <br/>
        <br/>
    </c:if>
    <c:if test="${isSupply == 1}">
        <div class="noWrap">
            <p class="shenqp pull-left">
                您好,<span>${p2pRegUserCertify.realName}</span>,请您根据平台管理人员提示，提交补充材料
            </p>
            <a style="margin-left: 160px;"
               href="javascript:sendForm('${financingInformationId}')"><input
                    type="button" style="margin-left: 12%" class="btn btn-default red"
                    value="提交补充材料">
            </a>
        </div>
    </c:if>
    ...
    <h2>申请进度：</h2>
    <div class="onlyone">
        <img src="${ctxStatic}/dist/images/jindu2/6.jpg" alt=""
