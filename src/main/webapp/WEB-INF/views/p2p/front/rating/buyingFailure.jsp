...
<head>
    ...
    <script type="text/javascript">
        ...
        function checkOtherfinance() {
            window.location.href = "${ctx}/financing/p2pFinancingRatingInfo/getRatingList";
        }
...
<div class="yycg">
    <h3>您已购买过该报告，请勿重复购买！</h3>
    <input type="button" value="返回我的账户" class="btn btn-default zh_btn i" onclick="goIndex();">
    <input type="button" value="返回报告列表" class="btn btn-default zh_btn" onclick="checkOtherfinance();">
</div>
<!-- 引入footer文件 -->
