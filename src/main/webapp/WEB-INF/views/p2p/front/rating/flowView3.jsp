...
<div class="zh-right pull-left jianjie shenq"
    ...
    <p class="shenqp pull-left">
        您好,<span>${p2pRegUserCertify.realName}</span>,您的债项评级材料已通过审核，请您支付评级费用
    </p>
    <a href="javascript:payFee('${financingInformationId}')"><input
            type="button" class="btn btn-default red" value="支付费用">
    </a><br/>
    <br/>
    <h2>申请进度：</h2>
    <div class="onlyone">
        <img src="${ctxStatic}/dist/images/jindu2/5.jpg" alt=""
...
<script type="text/javascript">
    ...
    function payFee() {
        ...
        paymentAmount = 1;//支付0.01元
        alert("flowView测试地址：" + paymentAmount + "元");
        /*post('
        ${ctx}/financing/payment/enterPay',
         {orderNo:orderNo,
