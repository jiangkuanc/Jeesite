    ...
    <div class="zh-left pull-left">
        <ul class="zhzl">
            <li data-i="0" class=" zhzllevel1  xiajian zhzl-li">
                <p class="zhtext "><a href="javascript:void(0)">我的评估任务</a></p>
                <ul class="zhzllevel2 leftMenu">
                    <li class=""><a href="${ctx}/user/AssetValuation/ctrlMenu">评估任务</a></li>
                </ul>
            </li>
            ...
            <li data-i="1" class=" zhzllevel1 xiajian zhzl-li">
                ...
                <ul class="zhzllevel2 leftMenu">
                    <li><a href="${ctx}/user/AssetValuation/ctrlMenu?mode=pwdManager">密码管理</a></li>
                </ul>
            </li>
        </ul>
    </div>
