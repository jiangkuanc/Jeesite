...
<body>
<div class="title"><h3>举报信息复审</h3></div>
...
<div id="type1" style="display:none;">
    <form id="submitForm" action="${ctx }/creditReport/reportReviewAudit/p2pReportFirstAudit">
        <h4>复审结果</h4>
...
<div id="type2" style="display:none;">
    ...
    <table class="table table-striped table-bordered table-condensed mytable">
        <tr>
            <td>复审意见</td>
            <td>${fns:getDictLabel(p2pReportInformationAudit.reviewOpinion, 'pass_nopass', '')}</td>
            <td>复审说明</td>
            <td>${p2pReportInformationAudit.reviewExplain }</td>
        </tr>
        <tr>
            <td>复审员</td>
            <td>${fns:getUserById(p2pReportInformationAudit.reviewOfficer).name}</td>
            <td>复审时间</td>
            <td><fmt:formatDate value="${p2pReportInformationAudit.reviewTime }" pattern="yyyy-MM-dd HH:mm:ss"/></td>
        </tr>
    </table>
</div>
</body>
