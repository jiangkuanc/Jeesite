...
<body>
<div class="title"><h3>申诉信息初审</h3></div>
...
<table class="table table-striped table-bordered table-condensed mytable">
    ...
    <tr>
        <td>申诉人姓名</td>
        <td>${fns:getUserById(p2pCreditReport.user.id).name}</td><!-- 代理人 -->
        <td>申诉人联系方式</td>
...
<div id="type1" style="display:none;">
    <form id="submitForm" action="${ctx }/creditReport/appealFirstAudit/p2pAppealFirstAudit">
        <h4>初审结果</h4>
        <input name="id" type="hidden" value="${p2pInformationAppeal.id }">
        <input name="firstReviewStaff" type="hidden" value="${fns:getUser()}">
        <table id="contentTable" class="table table-striped table-bordered table-condensed">
            <tr>
                <td>初审意见</td>
                <td>
                    <select name="firstReviewOpinion" class="input-medium-select">
            ...
            <tr>
                <td>初审说明</td>
                <td><textarea name="firstReviewExplain"></textarea></td>
            </tr>
        </table>
