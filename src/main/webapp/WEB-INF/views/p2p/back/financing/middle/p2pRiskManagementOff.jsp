...
<head>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            $("#riskManagementOffForm").validate({
...
<h4>暂停借贷产品</h4>
<form id="riskManagementOffForm" action="${ctx}/inFinancing/RiskManagementOff" method="post">
    <table class="table table-striped table-bordered table-condensed mytable">
        <tbody>
        <tr>
            <td>暂停人员<input type="hidden" name="financingInformationId" value="${p2pFinancingInformation.id}"></td>
        ...
        <tr>
            <td>暂停原因<input type="hidden" name="markType" value="${p2pFinancingInformation.markType}"></td>
