...
<body>
<div class="title"><h3>添加评估公司</h3></div>
<input id="btnCancel" class="btn fanhui" type="button" value="返 回" onclick="history.go(-1)"/>
<form id="registerAssetForm" action="${ctx}/user/userList/assetRegister" method="post" class="form-horizontal"
    ...
    <div class="row" style="margin:0px">
        ...
        <div class="col-md-6">
            <div class="control-group">
                <label class="control-label" style="height:27px"><h4>评估公司基本信息</h4></label>
            </div>
            <div class="control-group">
