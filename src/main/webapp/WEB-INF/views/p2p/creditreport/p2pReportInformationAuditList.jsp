...
<table id="contentTable" class="table table-striped table-bordered table-condensed">
    ...
    <c:forEach items="${page.list}" varStatus="status" var="p2pReportInformationAudit">
        <tr style="text-align: left;">
            ...
            <td>
                    ${p2pReportInformationAudit.firstOpinion}
            </td>
            <td>
                    ${p2pReportInformationAudit.firstStaff}
            </td>
            <td>
                    ${p2pReportInformationAudit.firstExplain}
            </td>
            <td>
                    ${p2pReportInformationAudit.firstTime}
            </td>
            <td>
                    ${p2pReportInformationAudit.reviewOpinion}
            </td>
            <td>
                    ${p2pReportInformationAudit.reviewOfficer}
            </td>
            <td>
                    ${p2pReportInformationAudit.reviewExplain}
            </td>
            <td>
                    ${p2pReportInformationAudit.reviewTime}
            </td>
            <td>
