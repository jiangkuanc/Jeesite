            ...
            <td>
                <c:choose>
                    <c:when test="${p2pInformationAppeal.appealAuditState=='1'}">
                        <a href="${ctx}/financing/p2pFinancingInformation/findFinancingDetailTwo?id=${p2pInformationAppeal.id}&name=${p2pInformationAppeal.p2pEnterpriseCertify.enterpriseName}">
                            审核
                        </a>
                    </c:when>
                    <c:otherwise>
                        <a href="${ctx}/financing/p2pFinancingInformation/findFinancingDetailOne?id=${p2pInformationAppeal.id}&name=${p2pInformationAppeal.p2pEnterpriseCertify.enterpriseName}">
                            查看
                        </a>
                    </c:otherwise>
                </c:choose>
