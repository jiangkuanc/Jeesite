...
<!-- 后台自定义 -->
<link href="${ctxStatic}/myback/myback.css" type="text/css" rel="stylesheet"/>
<script src="${ctxStatic}/myback/myback.js" type="text/javascript"></script>
<script src="${ctxStatic}/echarts/echarts-all.js"></script>
<script src="${ctxStatic}/myback/jqueryValidate.js" type="text/javascript"></script>
