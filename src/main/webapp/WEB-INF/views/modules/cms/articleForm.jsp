...
<form:form id="inputForm" enctype="multipart/form-data" modelAttribute="article" action="${ctx}/cms/article/save"
    ...
    <div class="control-group">
        <label class="control-label">讲堂名称:</label>
        <div class="controls">
    ...
    <div class="control-group">
        <label class="control-label">讲堂序号:</label>
        <div class="controls">
            <form:input path="lectureNumber" htmlEscape="false" maxlength="64" class="input-xlarge required"/>
            <span class="help-inline">第几讲。</span>
        </div>
    </div>
    <div class="control-group">
    ...
    <div class="control-group">
        <label class="control-label">讲堂摘要:</label>
        <div class="controls">
            <form:textarea path="description" htmlEscape="false" rows="4" maxlength="200" class="input-xxlarge"/>
        </div>
    </div>
    <div class="control-group">
        <label class="control-label">讲堂展示:</label>
        <div class="controls">
