...
<table width="901" border="1">
    <tbody>
    <tr>
        <td colspan="6" align="center"><h3>文章发布审核查看页——初审</h3></td>
    </tr>
    <c:forEach items="${page.list}" var="article">
        ...
        <tr>
            <td>审核意见:</td>
            <td colspan="2">${article.auditOpinion }</td>
            <td>不通过原因:</td>
            <td colspan="2">${article.nthroughReason }</td>
        </tr>
        <tr>
            <td>审核时间:</td>
            <td colspan="2"><fmt:formatDate value="${article.auditTime}" pattern="yyyy-MM-dd HH:mm:ss"/></td>
            <td>审核人:</td>
            <td colspan="2">${article.auditor }</td>
        </tr>
    </c:forEach>
    </tbody>
</table>
<form:form id="inputForm" modelAttribute="article" action="${ctx}/cms/article/recheck" method="post"
            ...
            <td colspan="6" align="center">
                <div class="form-actions">
                    <shiro:hasPermission name="cms:article:edit"><input id="btnSubmit" class="btn btn-primary"
                                                                        ...
                                                                        value="进行复审"/>&nbsp;&nbsp;&nbsp;</shiro:hasPermission>
