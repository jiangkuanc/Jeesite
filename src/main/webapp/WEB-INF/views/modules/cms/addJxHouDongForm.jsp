...
<ul class="nav nav-tabs">
    ...
    <li class="active"><a
            href="<c:url value='${fns:getAdminPath()}/cms/article/jingXingForm?id=${article.id}&category.id=${article.category.id}'><c:param name='category.name' value='${article.category.name}'/></c:url>">文章<shiro:hasPermission
...
<br/>
<form:form id="inputForm" enctype="multipart/form-data" modelAttribute="article" action="${ctx}/cms/article/save"
    ...
    <div class="control-group">
        <label class="control-label">活动展示:</label>
        <div class="controls">
            <input type="file" name="file"/>
            <img style="width:200px" src="${article.image }">
        </div>
    </div>

    <div class="control-group">
        <label class="control-label">活动讲师:</label>
        <div class="controls">
            <form:input path="speaker" htmlEscape="false" maxlength="200" class="input-xlarge"/>
        </div>
    </div>
    <div class="control-group">
    ...
    <div class="control-group">
        ...
        <div class="controls">
            <form:input path="activityLocation" htmlEscape="false" maxlength="200" class="input-xlarge"/>
        </div>
    </div>
    ...
    <div class="control-group">
        ...
        <div class="controls">
            <form:input path="registrationWay" htmlEscape="false" maxlength="200" class="input-xlarge"/>
        </div>
    </div>
    <%--
    <div class="control-group">
    ...
    <div class="control-group">
        ...
        <div class="controls">
            ...
            <input id="weightDate" name="weightDate" type="text" readonly="readonly" maxlength="20"
                   class="input-medium Wdate required"
                   value="<fmt:formatDate value="${article.weightDate}" pattern="yyyy-MM-dd HH:mm:ss"/>"
