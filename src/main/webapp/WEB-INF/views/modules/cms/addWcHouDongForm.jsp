...
<ul class="nav nav-tabs">
    ...
    <li class="active"><a
            href="<c:url value='${fns:getAdminPath()}/cms/article/WanChengForm?id=${article.id}&category.id=${article.category.id}'><c:param name='category.name' value='${article.category.name}'/></c:url>">文章<shiro:hasPermission
...
<form:form id="inputForm" enctype="multipart/form-data" modelAttribute="article" action="${ctx}/cms/article/save"
    ...
    <div class="control-group">
        <label class="control-label">活动回顾:</label>
        <div class="controls">
    ...
    <div class="control-group">
        <label class="control-label">活动寄语:</label>
        <div class="controls">
            <form:textarea path="eventMessage" htmlEscape="false" maxlength="200" class="input-xlarge"/>
        </div>
    </div>
    <%--
    <div class="control-group">
