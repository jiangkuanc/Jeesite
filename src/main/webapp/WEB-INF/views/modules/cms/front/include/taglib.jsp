...
<%@ taglib prefix="fic" uri="/WEB-INF/tlds/fic.tld" %>
...
<c:set var="path" value="${pageContext.request.contextPath}${fns:getAdminPath()}"/>
<c:set var="frontPath" value="${pageContext.request.contextPath}${fns:getFrontPath()}"/>