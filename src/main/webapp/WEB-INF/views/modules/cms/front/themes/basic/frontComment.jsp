...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        if (${!empty sessionScope.user}) {
            $("#loginName").val('${sessionScope.user.loginName}');
        } else {
            $("#loginName").val("匿名");
        }
    });
...
<ul>
    <c:forEach items="${page.list}" var="comment">
        <li>
            <h6 style="color:blue;">姓名: ${comment.name} &nbsp;时间：<fmt:formatDate value="${comment.createDate}"
...
<h5 style="margin-bottom: 0px;">我要评论</h5>
...
<script id="commentFormTpl" type="text/javascript">
    ...
    type = "submit"
    value = "提 交"
    style = "margin-left:10px;line-height: 12px;" / > & nbsp;
    </
    div >
    < / div >
    </form:form>
