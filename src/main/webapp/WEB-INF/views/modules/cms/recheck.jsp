...
<table width="901" border="1">
    <tbody>
    <tr>
        <td colspan="6" align="center"><h3>文章发布页——复审</h3></td>
    </tr>
...
<form:form id="inputForm" modelAttribute="article" action="${ctx}/cms/article/submit" method="post"
    ...
    <table width="901" border="1">
        <tr>
            <td>审核意见</td>
            <td colspan="2">
                <select id="reviewOpinions" name="reviewOpinions">
                    <option>同意</option>
                    <option>拒绝</option>
                </select>
            </td>
            <td>不通过原因</td>
            <td colspan="2"><form:textarea path="nreviewReason" htmlEscape="false" rows="1" maxlength="200"
                                           class="input-xxlarge"/>
                </form></td>
        </tr>
        <tr>
            ...
            <td colspan="2">
                <div class="control-group">
                    <div class="controls">
                        <fmt:formatDate value="${article.reviewTime}" type="both"/>
                    </div>
                </div>
            </td>
            <td>审核人</td>
            <td colspan="2"><form:input path="reauditor" htmlEscape="false" maxlength="200" class="input-xlarge"
