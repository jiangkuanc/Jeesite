...
<div class="zh-con">
        ...
        <ul class="zhzl">
            <li data-i="0" class=" zhzllevel1  xiajian zhzl-li">
                ...
                <ul class="zhzllevel2">
                    ...
                    <li><a href="${ctx }/cms/article/creditAptitude" style="color:#bf1a20;">平台简介</a></li>
                </ul>
            </li>
    ...
    <div class="zh-right pull-left jianjie" style="width:72.5%;padding-top: 0">
        ...
        <div style="text-indent:2EM;">
            <p>大公是中国政府授予特许经营权的信用评级机构：</p>

            <p>债券市场：</p>

            <p>1、中国人民银行认定的企业债券信用评级机构</p>

            <p>2、中国人民银行认定的银行间市场债券信用评级机构</p>

            <p>3、中国证监会认定的证券市场资信评级业务信用评级机构</p>

            <p>4、国务院发改委认定的企业债券信用评级机构 </p>

            <p>5、中国保监会认定的保险公司投资债券信用评级机构</p>

            <p>信贷市场：</p>

            <p>1、中国人民银行认定的借款企业信用评级机构</p>

            <p>2、中国人民银行认定的中小企业信用评级机构</p>

            <p>3、国务院发改委认定的中小企业信用评级机构</p>

            <p>4、国务院发改委认定的担保公司信用评级机构</p>

            <p>北京市科委、财政局、国税局、地税局联合认定的高新技术企业，中关村国家自主创新示范区高新技术企业。</p>
            <br/>
            <br/>
        </div>
    </div>
