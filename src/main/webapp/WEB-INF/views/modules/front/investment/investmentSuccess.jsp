...
<div class="zh">
    <ol class="breadcrumb update">
        ...
        <li><a href="javascript:;" onClick="javascript :history.back(-2);">债项详情</a></li>
        <li><a href="javascript:;" onClick="javascript :history.back(-1);">投资协议</a></li>
        <li class="lg-active">接受邀约</li>
    </ol>
</div>
<div class="yycg">
    <h3>您已接受投资邀约，请查看站内信-<a style="color: #4B9AE1" href="${ctx}/user/Institution/ctrlMenu?mode=msgCenter">投资邀约通知</a>获取融资企业的联系信息。
    </h3>
