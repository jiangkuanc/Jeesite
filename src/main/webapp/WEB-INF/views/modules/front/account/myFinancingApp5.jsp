...
<head>
    ...
    <script type="text/javascript">
        ...
        function sendForm(fid) {
            post('${ctx}/feedback/RateReceipt/viewRatingFeedback', {financingInformationId: fid})
        }
    </script>
</head>
<body>
...
<div class="zh-right pull-left jianjie shenq" style="width:72.5%;padding-bottom:30px;">
    <div class="noWrap"><p class="shenqp pull-left">您好,<span>${p2pRegUserCertify.realName}</span>,您所在企业的信用评级已经完成，
        请在查看评级结果后向我们反馈您的意见</p>
    ...
    <h2>申请进度：</h2>
    <div class="onlyone">
        <img src="${ctxStatic}/dist/images/jindu/7.jpg" alt="" style="margin-left: 7%;margin-top: 5%">
