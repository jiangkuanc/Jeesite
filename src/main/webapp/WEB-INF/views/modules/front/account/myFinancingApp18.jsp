...
<div class="zh-right pull-left jianjie shenq" style="width:72.5%;padding-bottom:30px;">
    <p class="shenqp pull-left">您好,<span>${p2pRegUserCertify.realName}</span>,您的融资申请已结束。</p><br/><br/>
    <h2>申请进度：</h2>
    <div class="onlyone">
        <c:if test="${page == 1}"><img src="${ctxStatic}/dist/images/jindu/7-9.jpg" alt=""
                                       style="margin-left: 7%;margin-top: 5%"></c:if>
        <c:if test="${page == 2}"><img src="${ctxStatic}/dist/images/jindu/7-21.jpg" alt=""
                                       style="margin-left: 7%;margin-top: 5%"></c:if>
        <c:if test="${page == 3}"><img src="${ctxStatic}/dist/images/jindu/7-2.jpg" alt=""
                                       style="margin-left: 7%;margin-top: 5%"></c:if>
        <c:if test="${page == 4}"><img src="${ctxStatic}/dist/images/jindu/7-7.jpg" alt=""
                                       style="margin-left: 7%;margin-top: 5%"></c:if>
            ...
            <div class="one">
                <table class="table table-hover">
                    ...
                    <tr>
                        ...
                        <td style="padding-left: 15px">评级费</td>
                        <td style="padding-left: 0px"><fmt:formatDate pattern="yyyy-MM-dd"
                                                                      value="${orderInfo.orderTime}"/></td>
                        <td style="padding-left: 30px"><fmt:formatNumber pattern="#,###.00"
                        ...
                        <td style="padding-left: 35px"><c:choose>
                            <c:when test="${!empty orderInfo.timeOfPayment}">
                                <fmt:formatDate pattern="yyyy-MM-dd" value="${orderInfo.timeOfPayment}"/></c:when>
                            <c:otherwise>-</c:otherwise>
                        </c:choose></td>
