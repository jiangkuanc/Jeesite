...
<div class="zh-right pull-left jianjie shenq" style="width:72.5%;padding-bottom:30px;">
    <p class="shenqp pull-left">您好,<span>${p2pRegUserCertify.realName}</span>,我们已根据您的申请为您做出了信用评级，
    </p>
    <p class="shenqp pull-left"> 同时我们也根据评级结果为您制定了融资方案，请您进行选择</p>
    <a class="redBtns pull-right"
       href="${ctx}/user/p2pUserInformation/loadDebtDetails?financingInformationId=${financingInformationId}"><input
            type="button" class="btn btn-default red" value="确认借款信息"></a>
    <p class="clearfix"></p>
    <h2 class="sqjdText">申请进度：</h2>
    <div class="onlyone">
        <c:if test="${page == 1}"><img src="${ctxStatic}/dist/images/jindu/7-10.jpg" alt=""
                                       style="margin-left: 7%;margin-top: 5%"></c:if>
        <c:if test="${page == 2}"><img src="${ctxStatic}/dist/images/jindu/7-4.jpg" alt=""
                                       style="margin-left: 7%;margin-top: 5%"></c:if>
        <c:if test="${page == 3}"><img src="${ctxStatic}/dist/images/jindu/7-14.jpg" alt=""
                                       style="margin-left: 7%;margin-top: 5%"></c:if>
        <c:if test="${page == 4}"><img src="${ctxStatic}/dist/images/jindu/7-18.jpg" alt=""
                                       style="margin-left: 7%;margin-top: 5%"></c:if>
    ...
    <div class="tabs">
        <ul>
            ...
            <!-- <li class="two border"><span>资产评估结果</span></li> -->
