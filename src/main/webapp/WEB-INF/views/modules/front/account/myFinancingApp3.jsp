...
<div class="zh-right pull-left jianjie shenq" style="width:72.5%;padding-bottom:30px;">
    <p class="shenqp pull-left">您好,<span>${p2pRegUserCertify.realName}</span>,您的借款项目评级材料已通过审核，请您支付评级费用</p>
    <a href="javascript:payFee('${financingInformationId}')"><input type="button" class="btn btn-default red"
                                                                    value="支付费用"></a><br/><br/>
    <h2>申请进度：</h2>
    <div class="onlyone">
        <img src="${ctxStatic}/dist/images/jindu/5.jpg" alt="" style="margin-left: 7%;margin-top: 5%">
...
<script type="text/javascript">
    // 真支付 start
    //支付20170724
    function payFee111(orderNo, orderTime) {
    ...
    function createOrder(str) {
        ...
        $.ajax({
            ...
            success: function (data) {
                var paymentStatu = '-';
                data.orderNo, new Date(), data.orderTime
    ...
    function payFee(fid) {
        alert('正在进行支付操作，请勿关闭窗口！' + fid);
        $.ajax({
            type: 'POST',
            url: '${ctx}/RatingFee/payRatingFee',
            data: {
