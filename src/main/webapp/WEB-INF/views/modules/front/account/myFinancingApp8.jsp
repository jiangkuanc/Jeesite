...
<div class="zh-right pull-left jianjie shenq" style="width:72.5%;padding-bottom:30px;">
    <p class="shenqp pull-left">您好,<span>${p2pRegUserCertify.realName}</span>,请您选择增信公司,进行下一步操作</p>
    <a href="javascript:submittedMaterial('${financingInformationId}')">
        <input type="button" class="btn btn-default red" value="选择增信公司" style="margin-left: 35%">
    </a><br/><br/><br/><br/>
    <h2>申请进度：</h2>
    <div class="onlyone">
        <c:if test="${page == 1}"><img src="${ctxStatic}/dist/images/jindu/7-8.jpg" alt=""
                                       style="margin-left: 7%;margin-top: 5%"></c:if>
        <c:if test="${page == 2}"><img src="${ctxStatic}/dist/images/jindu/7-3.jpg" alt=""
                                       style="margin-left: 7%;margin-top: 5%"></c:if>
...
<script type="text/javascript">
    ...
    function submittedMaterial(fid) {
        post('${ctx}/financing/submitMaterial/submitView', {financingInformationId: fid})
    }
