...
<div class="zh-right pull-left jianjie shenq" style="width:72.5%;padding-bottom:30px;">
    ...
    <c:if test="${isSupply == 0}">
        <p class="shenqp pull-left">您好,<span>${p2pRegUserCertify.realName}</span>,我们正在根据您的复评意见进行重新评级。</p><br/><br/>
    </c:if>
    ...
    <h2>申请进度：</h2>
    <div class="onlyone">
        <img src="${ctxStatic}/dist/images/jindu/7-1.jpg" alt="" style="margin-left: 7%;margin-top: 5%">
