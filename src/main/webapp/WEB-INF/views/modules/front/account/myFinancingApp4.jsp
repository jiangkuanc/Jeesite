...
<head>
    ...
    <script type="text/javascript">
        ...
        function sendForm(fid) {
            post('${ctx}/document/preSupplyDocument', {financingInformationId: fid})
        }
    </script>
</head>
<body>
...
<div class="zh-right pull-left jianjie shenq" style="width:72.5%;padding-bottom:30px;">
    <c:if test="${isSupply == 0}">
        <p class="shenqp pull-left">您好,<span>${p2pRegUserCertify.realName}</span>,您的借款项目正在进行评级，请耐心等候</p><br/><br/>
    </c:if>
    <c:if test="${isSupply == 1}">
        <div class="noWrap"><p class="shenqp pull-left">您好,<span>${p2pRegUserCertify.realName}</span>,请您根据平台管理人员提示，提交补充材料
        </p>
            <a style="margin-left: 160px;" href="javascript:sendForm('${financingInformationId}')"><input type="button"
    ...
    <h2>申请进度：</h2>
    <div class="onlyone">
        <img src="${ctxStatic}/dist/images/jindu/6.jpg" alt="" style="margin-left: 7%;margin-top: 5%">
