...
<div class="zh-right pull-left jianjie shenq" style="width:72.5%;padding-bottom:30px;">
    <c:if test="${orderInfo.paymentStatus == 0}">
        <p class="shenqp pull-left">您好,<span>${p2pRegUserCertify.realName}</span>,您的借款项目已经满标,投资方会在您支付完评级费用后,将借款转账给您</p>
    ...
    <c:if test="${orderInfo.paymentStatus == 1}">
        <p class="shenqp pull-left">您好,<span>${p2pRegUserCertify.realName}</span>,您的借款项目已经满标,请耐心等待管理人员审核,随后投资方会将借款转账给您
        </p>
    </c:if><br/>
    <h2>申请进度：</h2>
    <div class="onlyone">
