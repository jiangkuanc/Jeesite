...
<div class="zh-right pull-left jianjie shenq" style="width:72.5%;padding-bottom:30px;">
    <p class="shenqp pull-left">您好,<span>${p2pRegUserCertify.realName}</span>,请等待管理人员进行评级报告审核。</p><br/><br/>
    <h2>申请进度：</h2>
    <div class="onlyone">
        <c:if test="${page == 1}"><img src="${ctxStatic}/dist/images/jindu/7-1.jpg" alt=""
                                       style="margin-left: 7%;margin-top: 5%"></c:if>
        <c:if test="${page == 2}"><img src="${ctxStatic}/dist/images/jindu/7.jpg" alt=""
                                       style="margin-left: 7%;margin-top: 5%"></c:if>
