...
<div class="zh-con rzsq_con">
    <div class="renzheng">
        ...
        <div class="btn-box">
            <form action="${ctx}/document/doDocApp" method="post" id="form1">
...
<script>
    ...
    /* setTimeout(function(){
     var $filePreviewFrame = $(".file-input").find(".file-preview-frame");

     var $fileIndex = $filePreviewFrame.attr("data-fileindex");
     console.log($fileIndex)
     if($fileIndex>0||$fileIndex == 0){
     $filePreviewFrame.css({"opacity":.6})
     }
     },300) */
