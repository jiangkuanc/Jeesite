...
<head>
    ...
    <script type="text/javascript">
        function calc() {
            var b = $('#applicationRate').val() / 12;//月利率
            var p = $('#financingAmount').val();//本金
            var n = $('#financingMaturity').val();//期限
            var m = $('#repaymentMode').val();//还款方式
...
<div class="rzsq">
    ...
    <div class="rzsq-con">
        <form id="interviewForm" method="post" class="form-horizontal"
              action="${ctx}/financing/p2pFinancingInformation/financingApplication">
            ...
            <div class="form-group">
                ...
                <div class="col-lg-3" style="height:35px;">
                    <span style="line-height: 48px;font-size:14px">${p2pRegUserCertify.realName}</span>
                </div>
            </div>

            <div class="form-group">
                <label class="col-lg-2 control-label">申请利率<b style="color:#C1181D;font-size:16px;">*</b>：</label>
                <div class="col-lg-3 checkbox">
                    <select class="form-control" style="width: 60%;" id="applicationRate" name="applicationRate"
                            data-bv-notempty data-bv-notempty-message="请选择申请利率" onchange="calc()">
                    ...
                    <span style="font-size:14px;margin:0px 2px">%</span>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-lg-4 checkbox">
                    <input type="text" class="form-control" style="width:60%" placeholder="此处填写您的借款金额"
                           id="financingAmount" name="applicationAmount" onchange="calc()"/>
            ...
            <div class="form-group">
                ...
                <div class="col-lg-3 checkbox">
                    <select class="form-control" style="width: 60%;" id="financingMaturity" name="financingMaturity"
                            data-bv-notempty data-bv-notempty-message="请选择借款时长" onchange="calc()">
                        <option value="">请选择</option>
            ...
            <div class="form-group">
                ...
                <div class="col-lg-3 checkbox">
                    <select class="form-control" style="width: 60%;" id="repaymentMode" name="repaymentMode"
                            data-bv-notempty data-bv-notempty-message="请选择还款方式" onchange="calc()">
                        <option value="">请选择</option>
            ...
            <div class="form-group" id="raiseTimeLimit">
                <label class="col-lg-2 control-label">募集期限<b style="color:#C1181D;font-size:16px;">*</b>：</label>
                <div class="col-lg-3 checkbox noWrap">
                    <select class="form-control" style="width: 60%;" name="raiseTimeLimit" data-bv-notempty
                            data-bv-notempty-message="请选择募集期限">
                        <option value="">请选择</option>
            ...
            <div class="form-group">
                <label class="col-lg-2 control-label">预计还款总额<b style="color:#C1181D;font-size:16px;">*</b>：</label>
                <div class="col-lg-3 checkbox">
                    <input id="allAmount" readonly value="0.00"
                           style="border: none;width:50%;height:30px;text-align: left;padding-right:10px">
                    <span>元</span>
            ...
            <div class="form-group" id="myTextarea">
                ...
                <div class="col-lg-8 checkbox">
                    <textarea id="textarea" cols="58" name="purposeExplain" rows="5"
                              style="overflow: hidden;resize: none;border: 1px solid #ccc;"></textarea>
                </div>
            </div>
