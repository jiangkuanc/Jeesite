...
<div class="zh-con">
    ...
    <div class="zh-right pull-left zhzl_xxzx" style="margin-bottom: 200px">
        ...
        <ul class="xxList clearfix">
            <li class="pull-left">消息<span><a href="${ctx}/msg/msgLetterRecord/getMsgList">（${readJson + unReadJson}）</a></span>
            </li>
            ...
            <li class="pull-left">已读消息<span><a
                    href="${ctx}/msg/msgLetterRecord/getMsgList?readState=1">（${readJson}）</a></span></li>
        </ul>
                ...
                <c:forEach items="${list}" var="msgLetterRecord">
                    <tr>
                        <td><input type="hidden" name="id" value="${msgLetterRecord.id }"/><input type="checkbox"
                                                                                                  class="inpch"></td>
                        <td style="text-align: center;"><a id="title${msgLetterRecord.id}"
                                                           href="${ctx}/msg/msgLetterRecord/getById?msgId=${msgLetterRecord.id }">${msgLetterRecord.title}</a>
                        </td>
