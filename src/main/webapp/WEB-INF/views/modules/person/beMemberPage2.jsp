        ...
        <div class="zh-right-div">
            <h4>
                &nbsp;&nbsp;&nbsp;&nbsp;会员类型：<span style="color: #666666;">
						<c:out value="${p2pMember.memberType}" default="个人投资会员"></c:out>
					</span>
            </h4>
            <h4>
                &nbsp;&nbsp;&nbsp;&nbsp;支付费用：&nbsp;<span class="date"><c:out value="${p2pMemberPayDetails.payCost}"
                                                                             default="0.00"></c:out></span>元
            </h4>
            <h4>
                会员有效期：<span class="date">
					        <c:out value="${p2pMemberPayDetails.payCost}" default="2017年5月31日"></c:out></span>
            </h4>
            <p></p>
            <div class="col-md-4 col-md-offset-2">
                <a href="${ctx}/user/bankCard/beMember3" class="btn btn-primary mfkt_btn"
                   style="padding:0px;font-size:14px;">免费开通</a>
