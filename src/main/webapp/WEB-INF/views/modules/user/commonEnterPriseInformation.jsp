...
<head>
    ...
    <script type="text/javascript">
        $(function () {
            /*    alert("come");
             var operationPeriod='
            ${vo.operationPeriod}';//到期时间
             // operationPeriod=operationPeriod.replace(/-/g,"/");
             alert(operationPeriod);
             operationPeriod = new Date(operationPeriod);//到期时间
             alert("到期的时间是"+operationPeriod);
