...
<head>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $("#daibanInfo .dropdown-menu a").mouseup(function () {
                return addTab($(this), true);
            });
        ...
        $(function () {
            ...
            $("#daiban").click(function () {
                $.ajax({
                    type: 'post',
                    url: "${ctx}/p2p/config/homePage/selectTodos",
                    success: function (data) {
                        //个人认证
                        $("#personalCertifyNum span").html(data.personalCertifyNum);
                        //企业身份认证
                        $("#enterpriseAgentCertifyNum span").html(data.enterpriseAgentCertifyNum);
                        //企业认证
                        $("#enterpriseCertifyNum span").html(data.enterpriseCertifyNum);
                        //评级材料审核
                        $("#rateDocumentNum span").html(data.rateDocumentNum);
                        //立项市场确认
                        $("#lixiangNum span").html(data.lixiangNum);
                        //增信材料审核
                        $("#buxinNum span").html(data.buxinNum);
                        //债项发布
                        $("#fabuNum span").html(data.fabuNum);
                        //发布市场确认
                        $("#fabuquerenNum span").html(data.fabuquerenNum);
                        //满标审核
                        $("#manbiaoNum span").html(data.manbiaoNum);
                        //流标审核
                        $("#liubiaoNum span").html(data.liubiaoNum);
                    }
                });
            });
...
<div id="main">
    <div id="header" class="navbar navbar-fixed-top">
        <div class="navbar-inner">
            ...
            <ul id="userControl" class="nav pull-right">
                <!-- 下拉菜单开始 -->
                <li id="daibanInfo" class="dropdown">
                    <a id="daiban" href="#" class="dropdown-toggle" data-toggle="dropdown" href="#">
                        待办事项
                        <b class="caret"></b>
                    </a>
                    <ul class="dropdown-menu" id="navMenu">
                        <li><a id="personalCertifyNum" target='mainFrame'
                               href='${ctx}/user/certifyManage/personalCertifyList'>个人认证&nbsp;&nbsp;<span
                                style='float:right' class='label label-info'></span></a></li>
                        <li><a id="enterpriseAgentCertifyNum" target='mainFrame'
                               href='${ctx}/user/certifyManage/enterpriseCertifyList'>企业身份认证&nbsp;&nbsp;<span
                                style='float:right' class='label label-info'></span></a></li>
                        <li><a id="enterpriseCertifyNum" target='mainFrame'
                               href='${ctx}/user/certifyManage/enterpriseCertifyList'>企业认证&nbsp;&nbsp;<span
                                style='float:right' class='label label-info'></span></a></li>
                        <li><a id="rateDocumentNum" target='mainFrame' href='${ctx}/financing/findDocumentAuditList'>评级材料审核&nbsp;&nbsp;<span
                                style='float:right' class='label label-info'></span></a></li>
                        <li><a id="lixiangNum" target='mainFrame'
                               href='${ctx}/financing/p2pFinancingInformation/marketConfirmation'>立项市场确认&nbsp;&nbsp;<span
                                style='float:right' class='label label-info'></span></a></li>
                        <li><a id="buxinNum" target='mainFrame' href='${ctx}/sys/menu/goToCreatingPage/'>增信材料审核&nbsp;&nbsp;<span
                                style='float:right' class='label label-info'></span></a></li>
                        <li><a id="fabuNum" target='mainFrame'
                               href='${ctx}/financing/p2pFinancingInformation/debtIssued'>债项发布&nbsp;&nbsp;<span
                                style='float:right' class='label label-info'></span></a></li>
                        <li><a id="fabuquerenNum" target='mainFrame'
                               href='${ctx}/financing/p2pFinancingInformation/marketConfirmationReleaseDebt'>发布市场确认&nbsp;&nbsp;<span
                                style='float:right' class='label label-info'></span></a></li>
                        <li><a id="manbiaoNum" target='mainFrame' href='${ctx}/inFinancing/findFullAuditListPage'>满标审核&nbsp;&nbsp;<span
                                style='float:right' class='label label-info'></span></a></li>
                        <li><a id="liubiaoNum" target='mainFrame' href='${ctx}/inFinancing/findStandardAuditListPage'>流标审核&nbsp;&nbsp;<span
                                style='float:right' class='label label-info'></span></a></li>
                    </ul>
                </li>
    ...
    <div class="container-fluid">
        ...
        <div id="footer" class="row-fluid">
            丝路互金网运营管理系统 版权所有Copyright &copy; 2017 | All Rights Reserved 京ICP证160917号 京ICP备16012398号-4
            <!-- Copyright &copy; 2014-${fns:getConfig('copyrightYear')} ${fns:getConfig('productName')} -->
        </div>
    </div>
</div>
<script type="text/javascript">
    var leftWidth = 164; // 左侧窗口大小
