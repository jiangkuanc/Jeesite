    ...
    <div class="zh-con">
        ...
        <div class="zh-left pull-left" style="background-color: white">
            ...
            <ul class="zhzl" id="enterpriseMenu">
                ...
                <li class="active"
                    onclick="tiaozhuan('${ctx}/enterpriseDatabase/financial?financingInformationId=${financingInformationId}');">
                    <span>Ⅱ 财报数据</span>
                </li>
        ...
        <div class="zh-right pull-left" style="background-color: white">
            ...
            <div id="profitData" style="margin:0 auto;display: none">
                ...
                <table class="table" style="word-break:break-all; word-wrap:break-all;border-right: 1px solid #DDDDDD">
                    <thead>
                    ...
                    <c:forEach items="${profitData}" var="rateFinancialIndicator">
                        <c:choose>
                            <c:when test="${rateFinancialIndicator.financialIndicatorId=='FIN0002001000'
	    								|| rateFinancialIndicator.financialIndicatorId=='FIN0002002000'
	    								|| rateFinancialIndicator.financialIndicatorId=='FIN0002003000'
	    								|| rateFinancialIndicator.financialIndicatorId=='FIN0002004000'
	    								|| rateFinancialIndicator.financialIndicatorId=='FIN0002005000'
	    								|| rateFinancialIndicator.financialIndicatorId=='FIN0002006000'
	    								|| rateFinancialIndicator.financialIndicatorId=='FIN0002007000'}">
                                <tr style="background:#999999;color:#fff">
            ...
            <div id="bstyle" style="margin:0 auto;display: none">
                ...
                <table class="table" id="cashData"
                       style="word-break:break-all; word-wrap:break-all;border-right: 1px solid #DDDDDD">
                    <tbody>
                    <tr style="background:#999999;color:#fff;">
                        <td style="width:30px;">行次</td>
                    ...
                    <c:forEach items="${bstyle}" var="rateFinancialIndicator">
                        <c:choose>
                            <c:when test="${rateFinancialIndicator.financialIndicatorId=='FIN0003001000'
					    				|| rateFinancialIndicator.financialIndicatorId=='FIN0003002000'
					    				|| rateFinancialIndicator.financialIndicatorId=='FIN0003003000'}">
                            ...
                            <c:when test="${rateFinancialIndicator.financialIndicatorId=='FIN0003001100'
	    								|| rateFinancialIndicator.financialIndicatorId=='FIN0003001200'
	    								|| rateFinancialIndicator.financialIndicatorId=='FIN0003001300'
	    								|| rateFinancialIndicator.financialIndicatorId=='FIN0003002100'
	    								|| rateFinancialIndicator.financialIndicatorId=='FIN0003002200'
	    								|| rateFinancialIndicator.financialIndicatorId=='FIN0003002300'
	    								|| rateFinancialIndicator.financialIndicatorId=='FIN0003003100'
	    								|| rateFinancialIndicator.financialIndicatorId=='FIN0003003200'
	    								|| rateFinancialIndicator.financialIndicatorId=='FIN0003003300'
	    								|| rateFinancialIndicator.financialIndicatorId=='FIN0003005000'
	    								|| rateFinancialIndicator.financialIndicatorId=='FIN0003006000'}">
                                <tr style="background:#999999;color:#fff">
                                    <td style="background:#999999;color:#fff">${rateFinancialIndicator.orderNum}</td>
                                    <td style="background:#999999;color:#fff">${rateFinancialIndicator.financialIndicatorName}</td>
                                    <td>${rateFinancialIndicator.periodValue}</td>
            ...
            <div id="allData" style="margin:0 auto;">
                ...
                <table class="table" id="leftData"
                       style="word-break:break-all; word-wrap:break-all;border-right: 1px solid #DDDDDD">
                    <tbody>
                    <tr style="background:#999999;color:#fff">
                        <td style="width:50px;">行次</td>
                    ...
                    <c:forEach items="${allData}" var="rateFinancialIndicator">
                        <c:choose>
                            <c:when test="${rateFinancialIndicator.financialIndicatorId=='FIN0001001000'
	    								|| rateFinancialIndicator.financialIndicatorId=='FIN0001002000'}">
                                <tr style="height:47px;border-right: 1px solid">
                                    <td style="background:#999999;color:#fff">${rateFinancialIndicator.orderNum}</td>
                                    <td style="background:#999999;color:#fff">${rateFinancialIndicator.financialIndicatorName}</td>
                                    <td style="background:#999996;color:#fff">-</td>
                                    <td style="background:#999996;color:#fff">-</td>
                            ...
                            <c:when test="${rateFinancialIndicator.financialIndicatorId=='FIN0001001100'
	    								|| rateFinancialIndicator.financialIndicatorId=='FIN0001002100'
	    								|| rateFinancialIndicator.financialIndicatorId=='FIN0001000000'}">
                                <tr style="background:#999999;color:#fff">
                                    <td>${rateFinancialIndicator.orderNum}</td>
                                    <td>${rateFinancialIndicator.financialIndicatorName}</td>
                                    <td>${rateFinancialIndicator.periodValue}</td>
                ...
                <table class="table" id="rightData"
                       style="word-break:break-all; word-wrap:break-all;border-right: 1px solid #DDDDDD;border-bottom: 1px solid #DDDDDD">
                    <tbody>
                    <tr style="background:#999999;color:#fff;">
                        <td style="width:30px;">行次</td>
                    ...
                    <c:forEach items="${rateFinancialIndicatorsR}" var="rateFinancialIndicator">
                        <c:choose>
                            <c:when test="${rateFinancialIndicator.financialIndicatorId=='FIN0001013000'
					    				|| rateFinancialIndicator.financialIndicatorId=='FIN0001014000'
					    				|| rateFinancialIndicator.financialIndicatorId=='FIN0001016001'}">
                                <tr style="height:47px">
                                    <td style="background:#999999;color:#fff">${rateFinancialIndicator.orderNum}</td>
                                    <td style="background:#999999;color:#fff">${rateFinancialIndicator.financialIndicatorName}</td>
                                    <td style="background:#999996;color:#fff">-</td>
                            ...
                            <c:when test="${rateFinancialIndicator.financialIndicatorId=='FIN0001013100'
	    								|| rateFinancialIndicator.financialIndicatorId=='FIN0001014100'
	    								|| rateFinancialIndicator.financialIndicatorId=='FIN0001015000'
	    								|| rateFinancialIndicator.financialIndicatorId=='FIN0001016013'
	    								|| rateFinancialIndicator.financialIndicatorId=='FIN0001016100'
	    								|| rateFinancialIndicator.financialIndicatorId=='FIN0001010000'}">
                                <tr style="background:#999999;color:#fff">
                                    <td>${rateFinancialIndicator.orderNum}</td>
                                    <td>${rateFinancialIndicator.financialIndicatorName}</td>
                                    <td>${rateFinancialIndicator.periodValue}</td>
